    ...
    <div class="inventory-header">
      <div class="d-md-flex">
        <div class="mb-md-0 mb-6">
          <div style="cursor: pointer" @click="$router.push({name: 'InventoryHome'})">
            <v-icon class="mr-2">mdi-arrow-left</v-icon> Return to Inventory
          </div>
        </div>
        <v-spacer></v-spacer>
...
import CategoryList from "@/components/secondary/inventory/FMCGCategoryList.vue";
...
export default {
  ...
  computed: {
    ...mapGetters({
      products: "inventory/FMCGProducts",
    }),
    ...mapState({
